 ...
 * 
 * Memorija:        RAM:    used 25/25 bytes (100%)...free 0
 *                  FLASH:  used 315/512 bytes (62%)...free 197 bytes
...
//
    __CONFIG(MCLRDIS & WDTDIS & INTRC & UNPROTECT);
...
#define DIP_SW      GP5
//
//#define GPIO_Init() (GPIO = 0x00, TRIS = 0b00111000)
//
//-------------------------------- TIMER
//
//#define	TMR0_Init() (OPTION = 0b11000111, TMR0 = 61)
//
/******************************************************************************/
/***                                                                ***********/
